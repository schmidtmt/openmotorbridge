...
3. [ ] **Web-Dashboard:** Im Browser öffnen (unter **Android/PC/Mac:** Google Chrome oder MS Edge; unter **iPhone/iPad:** [Bluefy Web BLE Browser](https://apps.apple.com/app/bluefy-web-ble-browser/id1492822055) wegen iOS-WebKit-Vorgaben) via [`https://schmidtmt.github.io/openmotorbridge/`](https://schmidtmt.github.io/openmotorbridge/) oder lokal [`webapp_pwa/index.html`](file:///Users/schmidtm/openMotorBridge/webapp_pwa/index.html), auf "⚡ BLE Verbinden" klicken und mit `OpenMotorBridge_v8` koppeln.
