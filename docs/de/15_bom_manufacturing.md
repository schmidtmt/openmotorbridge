...
| **U2** | MAX-M10S-00B | u-blox | LGA-18 | C3006240 | Multi-Konstellation GNSS Engine (10 Hz, 1-PPS) |
...
| **J1** | PinSocket 1x06 P2.54mm | Wurth / JST | Horizontal Socket | C289118 | Heck-Pod 3 Hauptverbindung zur Zentralbox (5V, GND, UART, 1PPS, 1-Wire) |
| **J4, J5** | U.FL-R-SMT-1 / MM8030 | Hirose / Murata | SMD HF | C2834595 | HF-Koaxialbuchsen für LoRa (868 MHz) und GNSS (1575 MHz) |
| **J6** | SM03B-SRSS-TB | JST | 3-Pin JST-SH 1.0mm SMD | C136656 | Fahrtwind-Temperatursensorport (3V3, 1-Wire, GND) |
| **R2** | 4.7k 1% 0603 | Yageo / UniOhm | 0603 SMD | C23164 | 1-Wire Bus Pull-Up-Widerstand (POD3_1WIRE_ID) |
| **Sensor (ext)**| DS18B20 Edelstahl-Tauchfühler | Dallas / Maxim | Ø6x30mm IP67 | C2834580 | Wasserdichter 1-Wire Außentemperaturfühler im Fahrtwindkanal |
