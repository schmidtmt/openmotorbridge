...
*Figure 8.1: 3D CAD visualization of the Central Control Box (Type A).*
...
*Figure 8.4: Exploded view of the Satellite Pod with M8 socket, baseboard, bulkhead, and cartridge sled.*

![OpenMotorBridge Satellite Pod X-Ray Assembly](../images/cad/openmotorbridge_pod_assembly_render_xray.png)

*Figure 8.5: X-ray cutaway view of the closed Satellite Pod.*
...
*Figure 8.6: Cross-section showing the $6{,}0\,\text{mm}$ vertical height offset of the guide rails ($Z=8{,}2\,\text{mm}$ left, $Z=14{,}2\,\text{mm}$ right), rendering inverted insertion physically impossible.*
...
*Figure 8.7: The 4 modular cartridge variants (OMM Transceiver, Sena 50S/60S, Cardo Packtalk Edge, IP67 Dry Box).*
