...
def create_pcb_board():
    ...
    components = [
        ...
        ("Connector_JST.pretty", "JST_PH_B2B-PH-K_1x02_P2.00mm_Vertical", "J3", "PTT_IN_GND", 104.5, 103.0, 90,
         {"1": "PTT_RAW", "2": "GND"},
         "Connector_JST.3dshapes/JST_PH_B2B-PH-K_1x02_P2.00mm_Vertical.step"),

        # 2. Connectors East Edge (USB System Interface)
        ("Connector_JST.pretty", "JST_PH_B4B-PH-K_1x04_P2.00mm_Vertical", "J4", "USB_UPSTREAM_HOST", 163.5, 79.0, -90,
         {"1": "USB_UP_VBUS", "2": "USB_UP_DM", "3": "USB_UP_DP", "4": "GND"},
         "Connector_JST.3dshapes/JST_PH_B4B-PH-K_1x04_P2.00mm_Vertical.step"),
        ("Connector_JST.pretty", "JST_PH_B4B-PH-K_1x04_P2.00mm_Vertical", "J5", "USB_DN1_GLOVEBOX", 163.5, 91.0, -90,
         {"1": "VCC_5V", "2": "USB_DN1_DM", "3": "USB_DN1_DP", "4": "GND"},
         "Connector_JST.3dshapes/JST_PH_B4B-PH-K_1x04_P2.00mm_Vertical.step"),
        ("Connector_JST.pretty", "JST_PH_B4B-PH-K_1x04_P2.00mm_Vertical", "J6", "USB_DN2_CARPLAY", 163.5, 103.0, -90,
         {"1": "VCC_5V_OTTOCAST", "2": "USB_DN2_DM", "3": "USB_DN2_DP", "4": "GND"},
         "Connector_JST.3dshapes/JST_PH_B4B-PH-K_1x04_P2.00mm_Vertical.step"),

        # 3. North Edge: USB-C Service Port & Tactical Buttons
        ("Connector_USB.pretty", "USB_C_Receptacle_HRO_TYPE-C-31-M-12", "J7", "USB-C_SERVICE", 134.0, 72.5, 180,
        ...
        ("Button_Switch_SMD.pretty", "SW_Push_SPST_NO_Alps_SKRK", "SW1", "BOOT", 146.0, 74.0, 0,
         {"1": "ESP_BOOT", "2": "GND"},
         "Button_Switch_SMD.3dshapes/SW_Push_SPST_NO_Alps_SKRK.step"),
        ("Button_Switch_SMD.pretty", "SW_Push_SPST_NO_Alps_SKRK", "SW2", "RESET", 122.0, 74.0, 0,
         {"1": "ESP_EN", "2": "GND"},
         "Button_Switch_SMD.3dshapes/SW_Push_SPST_NO_Alps_SKRK.step"),
        ...
        ("RF_Module.pretty", "ESP32-C3-WROOM-02U", "U1", "ESP32-C3-WROOM-02U", 132.0, 96.0, 0,
        ...
        ("Sensor_Audio.pretty", "Knowles_SPH0645LM4H-6_3.5x2.65mm", "MIC1", "SPH0645_I2S_MIC", 123.0, 107.0, 0,
         {"1": "MIC_I2S_DATA", "2": "MIC_I2S_BCLK", "3": "MIC_I2S_WS", "4": "GND", "5": "VCC_3V3"},
         "Sensor_Audio.3dshapes/Knowles_SPH0645LM4H-6_3.5x2.65mm.step"),

        # 10. Status Indicator
        ("LED_SMD.pretty", "LED_0805_2012Metric", "D1", "LED_STATUS_GREEN", 132.0, 74.0, 0,
         {"1": "LED_STATUS", "2": "GND"},
        ...
        ("MountingHole.pretty", "MountingHole_2.7mm_M2.5_Pad_Via", "H4", "M2.5_MOUNT", 164.5, 110.5, 0, {"1": "GND"}, None),
    ]
